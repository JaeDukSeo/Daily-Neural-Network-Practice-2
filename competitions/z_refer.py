...
train_df = pd.read_csv(path+"train.csv", dtype=dtypes,  nrows=100,usecols=['ip','app','device','os', 'channel', 'click_time', 'is_attributed'], 
                        parse_dates=['click_time'])
print('load test....')
test_df = pd.read_csv(path+"test.csv", dtype=dtypes, nrows=100,usecols=['ip','app','device','os', 'channel', 'click_time', 'click_id'], 
                        parse_dates=['click_time'])

# Def: Get the original Training Data Length and append test data
