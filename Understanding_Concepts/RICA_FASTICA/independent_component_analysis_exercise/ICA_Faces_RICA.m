...
%  backtracking line search using the RICACost function 
...
[cost, grad] = RICACost(weightMatrix(:), visibleSize, numFeatures, patches_white, epsilon);
...
%         
        ...
        [newCost, newGrad] = RICACost(considerWeightMatrix(:), visibleSize, numFeatures, patches_white, epsilon);
