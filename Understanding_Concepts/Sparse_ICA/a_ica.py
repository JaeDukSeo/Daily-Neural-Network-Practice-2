...
class ICA_Layer():
    ...
    def backprop(self,l2_regularization=True):
...
train_batch = training_data_og[0:number_of_trainin_images,:]
...
# hyper
num_epoch = 500; learning_rate = 0.001; lamda = 0.003
...
l1 = ICA_Layer(16*16,act=tf_sigmoid,d_act=d_tf_sigmoid)
