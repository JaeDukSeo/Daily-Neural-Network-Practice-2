function v=lateral_flow_no_sky(pos,y0,v_max)

% LATERAL_FLOW_NO_SKY computes horizontal speeds in flows from ego-motion orthogonal to the optical axis
%
...
%
% USE: v = lateral_flow_no_sky(location,y0,v_max);
%
%  v = v_max*|y-y0|
%
