...
% More accurate guess
R1 = [8 49 29 79];   % tamaño subtopologia: [R(i,3)-R(i,1)+1 R(i,4)-R(i,2)+1]
R2 = [35 40 43 48];
R3 = [41 6 55 21];
R4 = [50 30 67 46];

% Squared regions
R1 = [8 49 29+9 79];   % tamaño subtopologia: [R(i,3)-R(i,1)+1 R(i,4)-R(i,2)+1]
R2 = [35 40 43 48];
R3 = [41 6 55+1 21];
R4 = [50 30 67 46+1];
...
func_criticas(1).filcol = [8 10;9 9;9 10;9 11;10 8;10 10;10 11;10 12;11 8;11 9;11 11;12 8;12 9;12 10;12 11;13 10;13 11;13 12;9 20;9 21;7 25;9 25;10 25;11 24];
...
figure(1),colormap gray,disp_patches(A1,sqrt(size(A1,2)),b);
figure(2),colormap gray,disp_patches(A2,sqrt(size(A2,2)),b);
figure(3),colormap gray,disp_patches(A3,sqrt(size(A3,2)),b);
figure(4),colormap gray,disp_patches(A4,sqrt(size(A4,2)),b);

A = A1;
save('tica_1x_100_sortu_1','A')
A = A2;
save('tica_1x_100_sortu_2','A')
A = A3;
save('tica_1x_100_sortu_3','A')
A = A4;
save('tica_1x_100_sortu_4','A')
