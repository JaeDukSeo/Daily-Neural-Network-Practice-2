...
elayer2_flatten = tf.reshape(elayer2_input,[batch_size,-1])
elayer2 = el2.feedforward(elayer2_flatten)
mean_data = tf.reduce_mean(elayer2,0)
center_matrix = elayer2 - mean_data
...
elayer3_input = tf.matmul(elayer2,e_vector)

# co varience matrix and eign values
elayer3 = el3.feedforward(elayer3_input)
mean_data_2 = tf.reduce_mean(elayer3,0)
center_matrix_2 = elayer3 - mean_data_2
covarience_matrix_2 = tf.matmul(tf.transpose(center_matrix_2),center_matrix_2) / batch_size   
e_value_2,e_vector_2 = tf.linalg.eigh(covarience_matrix_2)
d_layer_input_2 = tf.matmul(elayer3,e_vector_2)

elayer4 = el4.feedforward(d_layer_input_2)
dlayer0 = dl0.feedforward(elayer4)

# decoder
dlayer1 = dl1.feedforward(dlayer0)
