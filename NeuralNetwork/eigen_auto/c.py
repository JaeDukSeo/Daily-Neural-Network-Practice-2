...
mean_data = tf.reduce_mean(elayer3_flatten,0)
center_matrix = elayer3_flatten - mean_data
...
elayer3_flatten_changed = tf.matmul(elayer3_flatten,e_vector)

# finish the feed forward
