...
class FNN():
    def __init__(self,input_dim,hidden_dim,act,d_act):
        ...
        self.B = tf.Variable(tf.random_uniform([input_dim,hidden_dim],minval=-0.5,maxval=0.5))
    ...
    def backprop(self,gradient=None):
        ...
        grad_pass = tf.matmul(tf.multiply(grad_part_1,grad_part_2),tf.transpose(self.B))
