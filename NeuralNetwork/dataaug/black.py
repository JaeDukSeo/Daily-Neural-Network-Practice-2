...
class CNN():
    ...
    def feedforward(self,input,stride=1,padding='SAME'):
        ...
        # self.layerA1 = tf_elu(self.layer) 
        # self.layerA1 = -1.0*tf_elu(-1.0*self.layer) 

        self.layerA = tf.concat([tf_elu(self.layer[:,:,:,:78]),-1.0*tf_elu(-1.0*self.layer[:,:,:,78:])],axis=3)
...
l2 = CNN(3,channel_size*2,channel_size)
l3 = CNN(3,channel_size*3,channel_size)
l1w,l2w,l3w = l1.getw(),l2.getw(),l3.getw()

l4 = CNN(3,channel_size,channel_size)
l5 = CNN(3,channel_size*2,channel_size)
l6 = CNN(3,channel_size*3,channel_size)
l4w,l5w,l6w = l4.getw(),l5.getw(),l6.getw()

l7 = CNN(3,channel_size,channel_size)
l8 = CNN(1,channel_size*2,channel_size)
...
# layer0 = tf.nn.dropout(layer0,0.7)
...
# layer3 = tf.nn.dropout(layer3,0.6)
