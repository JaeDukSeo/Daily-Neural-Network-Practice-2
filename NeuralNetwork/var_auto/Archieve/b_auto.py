...
el1 = CNN(3,1,128)
el2 = CNN(3,128,256)
el3 = FNN(7*7*256,3,tf_iden,d_tf_iden)

dl1 = FNN(3,7*7*256,tf_iden,d_tf_iden)
dl2 = CNN_Trans(3,128,256)
dl3 = CNN_Trans(3,64,128)
final_cnn = CNN(5,64,1,tf_sigmoid,d_tf_sigmoid)
...
dlayer2_reshape = tf.reshape(dlayer1,[batch_size,7,7,256])
...
egrad2_Input = tf_repeat(tf.reshape(egrad3,[batch_size,7,7,256]),[1,2,2,1])
