...
train_batch = np.zeros((len(x_data),32,32,3))
test_batch = np.zeros((len(y_data),32,32,3))

for x in range(len(x_data)):
    train_batch[x,:,:,:] = imresize(x_data[x,:,:,:],(32,32))
for x in range(len(y_data)):
    test_batch[x,:,:,:] =  imresize(y_data[x,:,:,:],(32,32))
...
# define class here
channel_sizes = 256
l1 = CNN(5,3,channel_sizes,stddev=0.005)
l2 = CNN(5,channel_sizes,channel_sizes,stddev=0.005)
l3 = CNN(5,channel_sizes,channel_sizes,stddev=0.005)

l4 = CNN(5,channel_sizes,channel_sizes,stddev=0.005)
l5 = CNN(5,channel_sizes,channel_sizes,stddev=0.005)
l6 = CNN(5,channel_sizes,channel_sizes,stddev=0.005)

l7 = CNN(5,channel_sizes,channel_sizes,stddev=0.005)
l8 = CNN(1,channel_sizes,channel_sizes,stddev=0.005)
l9 = CNN(1,channel_sizes,10,stddev=0.005)
...
with tf.Session() as sess:
    ...
    for iter in range(num_epoch):
        ...
        for batch_size_index in range(0,len(train_batch),batch_size//2):
            ...
            sess_result = sess.run([cost,accuracy,correct_prediction,auto_train],
