...
dl4 = CNN_Trans(3,3,11)
fl4 = CNN(3,3,3)

dl5 = CNN_Trans(3,3,11)
fl5 = CNN(3,3,1,act=tf_sigmoid)
# hyper
num_epoch = 1201
...
# dlayer0_input = tf.tile(dlayer0_input,[1,3,3,1])
dlayer0 = dl0.feedforward(dlayer0_input,stride=3) # 2 2

dlayer1 = dl1.feedforward(dlayer0,stride=4) # 4 4
flayer1 = fl1.feedforward(dlayer1)

dlayer2 = dl2.feedforward(flayer1,stride=2) # 8 8
flayer2 = fl2.feedforward(dlayer2)

dlayer3 = dl3.feedforward(tf.concat([flayer2,elayer3],3),stride=2)
flayer3 = fl3.feedforward(dlayer3)

dlayer4 = dl4.feedforward(tf.concat([flayer3,elayer2],3),stride=2)
flayer4 = fl4.feedforward(dlayer4)

dlayer5 = dl5.feedforward(tf.concat([flayer4,elayer1],3),stride=1)
flayer5 = fl5.feedforward(dlayer5)
