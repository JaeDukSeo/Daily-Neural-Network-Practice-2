...
def f1(): return parameter_num ** (-0.5)  * iter_variable ** -0.5
def f2(): return parameter_num ** (-0.5)  * iter_variable * (4000 ** -1.5)
learning_rate_dynamic = tf.cond(tf.less(iter_variable ** -0.5, iter_variable * (4000 ** -1.5) ), true_fn=f1, false_fn=f2)
