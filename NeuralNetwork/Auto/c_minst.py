...
l2 = CNN(3,100,200)
l3 = CNN(3,200,300)
l3_prep = FNN(12*12*300,1000)

mean_vector,std_vector = FNN(1000,1000),FNN(1000,1000)

l4_prep = FNN(1000,1000)
l4 = FNN(1000,12*12*300)
...
samples = tf.random_normal([batch_size,1000], 0, 1, dtype=tf.float32)
