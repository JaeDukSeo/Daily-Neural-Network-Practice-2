...
layer3 = l3.feedforward(layer2+decay_dilated_rate*layer1,stride=2)

# layer4_Input = tf.nn.avg_pool(layer3,ksize=[1,2,2,1],strides=[1,2,2,1],padding='VALID')
layer4 = l4.feedforward(layer3)
layer5 = l5.feedforward(layer4)
layer6 = l6.feedforward(layer5+decay_dilated_rate*layer4,stride=2)
...
grad7,grad7_up = l7.backprop(grad8+decay_dilated_rate*grad9,learning_rate_change=learning_rate_change)

# grad6_Input = tf_repeat(grad7,[1,2,2,1])
grad6,grad6_up = l6.backprop(grad7,learning_rate_change=learning_rate_change,stride=2)
grad5,grad5_up = l5.backprop(grad6,learning_rate_change=learning_rate_change)
grad4,grad4_up = l4.backprop(grad5+decay_dilated_rate*grad6,learning_rate_change=learning_rate_change)

# grad3_Input = tf_repeat(grad4,[1,2,2,1])
grad3,grad3_up = l3.backprop(grad4,learning_rate_change=learning_rate_change,stride=2)
grad2,grad2_up = l2.backprop(grad3,learning_rate_change=learning_rate_change)
grad1,grad1_up = l1.backprop(grad2+decay_dilated_rate*grad3,learning_rate_change=learning_rate_change)
...
with tf.Session() as sess:
    ...
    for iter in range(num_epoch):
        ...
        if iter % print_size==0:
            ...
            print("Dilated Rate: ", proportion_rate * (1.0/(1.0+decay_rate*iter)))
