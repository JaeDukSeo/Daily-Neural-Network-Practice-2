...
# l11 = CNN(1,channel_size,channel_size,tf_elu,d_tf_elu)
# l12 = CNN(1,channel_size,10,tf_elu,d_tf_elu)
...
# layer10 = l10.feedforward(layer10_Input,droprate=droprate3)
...
# grad12,grad12_up = l12.backprop(grad_prepare,learning_rate_change=learning_rate_change,adam=True,reg=True,batch_size_dynamic=batch_size_dynamic)
# grad11,grad11_up = l11.backprop(grad12,learning_rate_change=learning_rate_change,awsgrad=True,batch_size_dynamic=batch_size_dynamic)
# grad10,grad10_up = l10.backprop(grad11+decay_dilated_rate*grad12,learning_rate_change=learning_rate_change,adam=True,reg=True,batch_size_dynamic=batch_size_dynamic)
...
grad6,grad6_up = l6.backprop(grad6_Input,learning_rate_change=learning_rate_change,adam=True,reg=True,batch_size_dynamic=batch_size_dynamic)
...
grad4,grad4_up = l4.backprop(grad5+decay_dilated_rate*grad6,learning_rate_change=learning_rate_change,adam=True,reg=True,batch_size_dynamic=batch_size_dynamic)

grad3_Input = tf_repeat(grad4,[1,2,2,1])
grad3,grad3_up = l3.backprop(grad3_Input,learning_rate_change=learning_rate_change,awsgrad=True,reg=True,batch_size_dynamic=batch_size_dynamic)
...
grad1,grad1_up = l1.backprop(grad2+decay_dilated_rate*grad3,learning_rate_change=learning_rate_change,awsgrad=True,reg=True,batch_size_dynamic=batch_size_dynamic)
...
with tf.Session() as sess:
    ...
    for iter in range(num_epoch):
        ...
        for batch_size_index in range(0,len(train_batch),batch_size//2):
            ...
            iter_variable:iter,learning_rate_dynamic:learning_rate,batch_size_dynamic:current_batch.shape[0],droprate1:random_drop1,droprate2:random_drop2,droprate3:random_drop3})
