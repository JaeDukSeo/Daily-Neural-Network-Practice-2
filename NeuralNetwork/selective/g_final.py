...
layer4 = l4.feedforward(layer3,droprate=droprate2,stride=2)
...
layer7 = l7.feedforward(layer6,droprate=droprate3,stride=2)
layer8 = l8.feedforward(layer7,droprate=droprate1)
layer9 = l9.feedforward(layer8+decay_dilated_rate*layer7,droprate=droprate2)
...
grad7,grad7_up = l7.backprop(grad8+decay_dilated_rate*grad9,learning_rate_change=learning_rate_change,awsgrad=True,batch_size_dynamic=batch_size_dynamic,stride=2)

# grad6_Input = tf_repeat(grad7,[1,2,2,1])
grad6,grad6_up = l6.backprop(grad7,learning_rate_change=learning_rate_change,awsgrad=True,batch_size_dynamic=batch_size_dynamic)
...
grad4,grad4_up = l4.backprop(grad5+decay_dilated_rate*grad6,learning_rate_change=learning_rate_change,awsgrad=True,batch_size_dynamic=batch_size_dynamic,stride=2)
...
layer4_ad = l4.feedforward(layer3_ad,droprate=droprate2,stride=2)
...
layer7_ad = l7.feedforward(layer6_ad,droprate=droprate3,stride=2)
layer8_ad = l8.feedforward(layer7_ad,droprate=droprate1)
layer9_ad = l9.feedforward(layer8_ad+decay_dilated_rate*layer7_ad,droprate=droprate2)
...
grad7_ad,grad7_up_ad = l7.backprop(grad8_ad+decay_dilated_rate*grad9_ad,learning_rate_change=learning_rate_change,awsgrad=True,batch_size_dynamic=batch_size_dynamic,stride=2)

# grad6_Input_ad = tf_repeat(grad7_ad,[1,2,2,1])
grad6_ad,grad6_up_ad = l6.backprop(grad7_ad,learning_rate_change=learning_rate_change,awsgrad=True,batch_size_dynamic=batch_size_dynamic)
...
grad4_ad,grad4_up_ad = l4.backprop(grad5_ad+decay_dilated_rate*grad6_ad,learning_rate_change=learning_rate_change,awsgrad=True,batch_size_dynamic=batch_size_dynamic,stride=2)

# grad3_Input_ad = tf_repeat(grad4_ad,[1,2,2,1])
grad3_ad,grad3_up_ad = l3.backprop(grad4_ad,learning_rate_change=learning_rate_change,awsgrad=True,batch_size_dynamic=batch_size_dynamic)
