...
# Code from: https://github.com/mwv/zca/blob/master/zca/zca.py
...
with tf.Session() as sess:
    ...
    for iter in range(num_epoch):
        ...
        for batch_size_index in range(0,len(train_batch),batch_size//2):
            ...
            iter_variable:iter,learning_rate_dynamic:learning_rate,droprate1:0.98,droprate2:0.98,droprate3:0.98,batch_size_dynamic:batch_size}
