...
layer8 = l8.feedforward(layer7,droprate=droprate1,stride=2)

layer9  = l9.feedforward(layer8,droprate=droprate1)
layer10 = l10.feedforward(layer9,droprate=droprate3)
layer11 = l11.feedforward(layer10,droprate=droprate2)
layer12 = l12.feedforward(layer11,droprate=droprate3,stride=2)
