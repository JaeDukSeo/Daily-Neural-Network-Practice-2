...
class CNN():
    ...
    def backprop(self,gradient,learning_rate_change,stride=1,padding='SAME',adam=True,reg=False):
        ...
        update_w = []
        update_w.append(
            tf.assign( self.m,self.m*0.9 + learning_rate_change * (grad)   )
        )
...
layer8 = l8.feedforward(layer7,padding='VALID',droprate=droprate2)
layer9 = l9.feedforward(layer8,padding='VALID',droprate=droprate1)
