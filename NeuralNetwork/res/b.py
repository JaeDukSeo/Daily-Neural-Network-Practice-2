...
l2_3 = CNN(1,channel_size,channel_size,tf_elu,d_tf_elu)
l1w,l2w,l2_3w = l1.getw(),l2.getw(),l2_3.getw()

l3 = CNN(3,channel_size,channel_size,tf_elu,d_tf_elu)
l4 = CNN(3,channel_size,channel_size,tf_elu,d_tf_elu)
l4_5 = CNN(1,channel_size,channel_size,tf_elu,d_tf_elu)
l3w,l4w,l4_5w = l3.getw(),l4.getw(),l4_5.getw()

l5 = CNN(3,channel_size,channel_size,tf_elu,d_tf_elu)
l6 = CNN(3,channel_size,channel_size,tf_elu,d_tf_elu)
l6_7 = CNN(1,channel_size,channel_size,tf_elu,d_tf_elu)
l5w,l6w,l6_7w = l5.getw(),l6.getw(),l6_7.getw()

l7 = CNN(3,channel_size,channel_size,tf_elu,d_tf_elu)
l8 = CNN(3,channel_size,channel_size,tf_elu,d_tf_elu)
l8_9 = CNN(1,channel_size,channel_size,tf_elu,d_tf_elu)
l7w,l8w,l8_9w = l7.getw(),l8.getw(),l8_9.getw()
...
layer2_3 = l2_3.feedforward(layer2,droprate=droprate1)

layer3_Input = tf.nn.avg_pool(layer2_3,ksize=[1,2,2,1],strides=[1,2,2,1],padding="VALID")
layer3 = l3.feedforward(layer3_Input,droprate=droprate3)
layer4 = l4.feedforward(layer3,droprate=droprate2)
layer4_5 = l4_5.feedforward(layer3_Input +layer4,droprate=droprate1,stride=2 )

layer5 = l5.feedforward(layer4_5,droprate=droprate3)
layer6 = l6.feedforward(layer5,droprate=droprate1)
layer6_7 = l6_7.feedforward(layer4_5 +layer6,droprate=droprate1 )
...
layer8_9 = l8_9.feedforward(layer7_Input +layer8,droprate=droprate1)

layer9 = l9.feedforward(layer8_9,droprate=droprate2)
...
# l2_reg = tf.nn.l2_loss(l1w) + tf.nn.l2_loss(l2w) + tf.nn.l2_loss(l2_3w) + \
#          tf.nn.l2_loss(l3w) + tf.nn.l2_loss(l4w) + tf.nn.l2_loss(l4_5w) + \
#          tf.nn.l2_loss(l5w) + tf.nn.l2_loss(l6w) + tf.nn.l2_loss(l6_7w) + \
#          tf.nn.l2_loss(l7w) + tf.nn.l2_loss(l8w) + tf.nn.l2_loss(l8_9w) +  \
#          tf.nn.l2_loss(l9w) 
...
grad8_9,grad8_9_up = l8_9.backprop(grad9,learning_rate_change=learning_rate_change,awsgrad=True,batch_size_dynamic=batch_size_dynamic)
grad8,grad8_up = l8.backprop(grad8_9,learning_rate_change=learning_rate_change,adam=True,batch_size_dynamic=batch_size_dynamic)
...
grad6_7_Input = tf_repeat(grad8_9 + grad7,[1,2,2,1])
grad6_7,grad6_7_up = l6_7.backprop(grad6_7_Input,learning_rate_change=learning_rate_change,awsgrad=True,batch_size_dynamic=batch_size_dynamic)
grad6,grad6_up = l6.backprop(grad6_7,learning_rate_change=learning_rate_change,awsgrad=True,batch_size_dynamic=batch_size_dynamic)
...
grad4_5_Input = grad5 + grad6_7
grad4_5,grad4_5_up = l4_5.backprop(grad4_5_Input,learning_rate_change=learning_rate_change,awsgrad=True,batch_size_dynamic=batch_size_dynamic,stride=2)
grad4,grad4_up = l4.backprop(grad4_5,learning_rate_change=learning_rate_change,awsgrad=True,batch_size_dynamic=batch_size_dynamic)
...
grad2_3_Input = tf_repeat(grad3 + grad4_5,[1,2,2,1])
grad2_3,grad2_3_up = l2_3.backprop(grad2_3_Input,learning_rate_change=learning_rate_change,awsgrad=True,batch_size_dynamic=batch_size_dynamic)
grad2,grad2_up = l2.backprop(grad2_3,learning_rate_change=learning_rate_change,adam=True,batch_size_dynamic=batch_size_dynamic)
...
grad_update = grad9_up + \
              grad8_9_up + grad8_up + grad7_up + \
              grad6_7_up + grad6_up + grad5_up + \
              grad4_5_up + grad4_up + grad3_up + \
              grad2_3_up + grad2_up + grad1_up
# ===== manual ====
