...
layer6 = l6.feedforward(layer5+decay_dilated_rate * layer4_Input)
...
layer9 = l9.feedforward(layer8+decay_dilated_rate * layer7_Input)
...
with tf.Session() as sess:
    ...
    for iter in range(num_epoch):
        ...
        for batch_size_index in range(0,len(train_batch),batch_size//2):
            ...
            iter_variable:iter,learning_rate_dynamic:learning_rate,droprate1:1.0,droprate2:1.0,droprate3:1.0,batch_size_dynamic:current_batch.shape[0]}
