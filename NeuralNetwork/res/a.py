...
layer4_5 = l4_5.feedforward(layer3_Input +layer4,droprate=droprate1 )

layer5_Input = tf.nn.avg_pool(layer4_5,ksize=[1,2,2,1],strides=[1,2,2,1],padding="VALID")
layer5 = l5.feedforward(layer5_Input,droprate=droprate3)
layer6 = l6.feedforward(layer5,droprate=droprate1)
layer6_7 = l6_7.feedforward(layer5_Input +layer6,droprate=droprate1 )
...
layer9_Input = tf.nn.avg_pool(layer8_9,ksize=[1,2,2,1],strides=[1,2,2,1],padding="VALID")
...
auto_train = tf.train.AdamOptimizer(learning_rate=learning_rate_change).minimize(cost + 0.5 * l2_reg)
