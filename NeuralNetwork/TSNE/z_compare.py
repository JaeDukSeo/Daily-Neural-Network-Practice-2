...
X_embedded = TSNE(n_components=2,perplexity=30,learning_rate=learning_rate,n_iter_without_progress =num_epoch).fit_transform(train_batch)
...
plt.scatter(X_embedded[:, 0], X_embedded[:, 1], c=color_mapping,marker='^', s=10)
plt.show()
